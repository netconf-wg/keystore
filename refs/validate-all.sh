...
yanglint -s ../ietf-keystore\@*.yang ./ietf-origin.yang ex-keystore.xml
...
yanglint -s -m ../ex-keystore-usage\@*.yang ../ietf-keystore\@*.yang ./ietf-origin.yang  ex-keystore-usage.xml ex-keystore.xml
